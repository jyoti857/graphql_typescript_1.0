...
let ProductResolver = class ProductResolver {
    ...
    // create Product
    createProduct({ name, description, color, stock, categories_id, price }) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    deleteProduct(id) {
        return __awaiter(this, void 0, void 0, function* () {
            yield Product_1.ProductModel.deleteOne({ _id: id });
            return true;
        });
    }
    Category(product) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (yield Categories_1.CategoriesModel.findById(product._doc.categories_id));
        });
    }
};
__decorate([
...
__decorate([
    type_graphql_1.Query(_returns => [Product_1.Product]),
    __metadata("design:type", Function),
